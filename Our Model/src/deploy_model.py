...
def run_nb():
    ...
    print("Running...")
    train_tweets = file_paths.us_tweets_path_train
    train_labels = file_paths.us_labels_path_train
    test_tweets = file_paths.us_tweets_path_test
    test_labels = file_paths.us_labels_path_test
